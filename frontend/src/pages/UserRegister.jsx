...
export default function UserRegister() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Ensure registration fields are available to the frontend profile flow.
      if (data.profile) {
  ...
  return (
    <main className="user-page">
      <img className="user-bg" src={heroBg} alt="Office background" />
      ...
      <div className="user-container">
        <div className="user-card">
          ...
          <form className="user-form" onSubmit={handleSubmit}>
            ...
            <input name="phone_number" type="tel" required placeholder="Phone Number" />
          ...
          <div className="user-footer">
            ...
            <button className="link" onClick={() => (window.location.hash = '#/user-login')}>
              Login
            </button>
          </div>
